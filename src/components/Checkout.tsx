...
const Checkout = () => {
  ...
  if (cart.length === 0) {
    return (
      <div className="container mx-auto py-16 px-4 text-center">
        <h2 className="text-2xl font-serif text-[#1B3A2D] mb-4">Your cart is empty</h2>
        <p className="text-gray-500 mb-8">Add some products before checking out.</p>
        <a href="/shop" className="px-8 py-3 rounded-full bg-[#2B5F3A] text-white font-medium hover:bg-[#224a2e] transition-colors">
          Browse Shop
        </a>
      </div>
    );
  ...
  return (
    <div className="container mx-auto py-12 px-4 max-w-5xl">
      <h1 className="text-3xl font-serif text-[#1B3A2D] mb-8">Checkout</h1>
