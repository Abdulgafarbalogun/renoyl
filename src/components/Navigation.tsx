      ...
      <div className="container mx-auto flex items-center justify-between flex-wrap">
        ...
        <div className={`w-full block flex-grow lg:flex lg:items-center lg:w-auto ${isMenuOpen ? 'block' : 'hidden'}`}>
          ...
          <div className="mt-4 lg:mt-0">
            <Link href="/cart" className="inline-flex items-center text-sm px-4 py-2 leading-none border rounded text-primary-green border-primary-green hover:border-transparent hover:text-white">
